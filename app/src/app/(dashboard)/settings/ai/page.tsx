...
/**
 * Static fallback used when the API is unavailable. Kept in sync with the
 * ai-engine PROVIDER_CATALOG: only the three wired adapters (openai, anthropic,
 * ollama) ship today. Additional providers (deepseek, groq, gemini, moonshot/kimi,
 * mistral, xai, openrouter, together, fireworks, cohere) are roadmap — the live
 * /listProviders catalog is the source of truth once an adapter is wired.
 */
...
/** Provider IDs available in Community edition (the three wired adapters) */
const COMMUNITY_PROVIDER_IDS = new Set(['openai', 'anthropic', 'ollama']);
