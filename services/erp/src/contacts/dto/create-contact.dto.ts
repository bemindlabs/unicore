...
export enum ContactType {
  LEAD = 'LEAD', CUSTOMER = 'CUSTOMER', VENDOR = 'VENDOR', PARTNER = 'PARTNER',
}

export class CreateContactDto {
  @IsEnum(ContactType) @IsOptional() type?: ContactType = ContactType.LEAD;
  ...
  @IsInt() @Min(0) @Max(100) @IsOptional() leadScore?: number = 0;
