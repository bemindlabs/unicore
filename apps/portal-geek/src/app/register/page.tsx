...
import { Terminal, Loader2, Eye, EyeOff, KeyRound } from 'lucide-react';
...
export default function RegisterPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      // Validate license key has geekCli flag
      if (licenseKey) {
        ...
        if (!licData.features?.geekCli) {
          setError('This license does not include the Geek CLI add-on. Please upgrade your plan.');
          return;
        }
      }
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full rounded-md border border-zinc-800 bg-zinc-900 py-2 pl-10 pr-3 text-sm font-mono text-zinc-50 placeholder-zinc-600 focus:border-green-600 focus:outline-none focus:ring-1 focus:ring-green-600"
                placeholder="UC-XXXX-XXXX-XXXX-XXXX"
              />
            </div>
            <p className="mt-1 text-[11px] text-zinc-600">
              Enter your license key to activate Geek CLI features immediately.
            </p>
          </div>
