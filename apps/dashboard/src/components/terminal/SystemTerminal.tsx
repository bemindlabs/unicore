...
function buildHelp(): OutputLine[] {
  return [
    ...
    line('╚══════════════════════════════════════════════════════╝', 'cyan'),
    line(''),
    line('System commands (OWNER role required):', 'yellow'),
    line(''),
    ...
    line(''),
    line('ERP commands:', 'yellow'),
    line(''),
    line('  /erp contacts [search]    List contacts (optional search)', 'white'),
    line('  /erp orders [status]      List orders (optional status filter)', 'white'),
    line('  /erp inventory            Stock levels with low-stock flags', 'white'),
    line('  /erp revenue [period]     Revenue summary', 'white'),
    line('  /erp invoice <id>         Invoice detail by ID', 'white'),
    line('  /erp report pnl           P&L monthly report', 'white'),
    line(''),
